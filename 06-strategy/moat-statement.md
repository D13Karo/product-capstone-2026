...
|------------------|---------------------|-------------------------|
| Organizer 4-week retention cohort (Sprint 2 cohort returning to create a 2nd, 3rd, 4th match) | The organizer is building a repeating-behaviour pattern that has cost to abandon | PostHog cohort export of `match_created` events grouped by `user_id`, run on the Sprint 2 cohort once 4 weeks of data exists. Levan exports to `03-build/analytics/organizer-retention-cohort.png` by **8 July 2026** |
