...
| R4 | Usage counts can't be read cleanly from the Django admin (e.g. User/Match/RSVP models not registered, or fields missing) | Low | Medium | When usage numbers are needed for a checkpoint or the pitch | Ensure the User, Match, and RSVP models are registered in the Django admin; Davit (PO) verifies signup/join counts load in the admin as part of S1-04 AC2 acceptance | Levan Kovziridze | Open |
